...
async def to_code(config):
    ...
    cg.add_library("https://github.com/BoschSensortec/Bosch-BME68x-Library.git#v1.1.40407")
    cg.add_library("https://github.com/BoschSensortec/Bosch-BSEC2-Library.gitv1.4.2200")
